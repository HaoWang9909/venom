...
make clean
cmake .. -DCMAKE_BUILD_TYPE=Debug -DCUDA_ARCHS="90" -DBASELINE=OFF -DIDEAL_KERNEL=OFF -DOUT_32B=ON && make -j 16
...
make clean
cmake .. -DCMAKE_BUILD_TYPE=Debug -DCUDA_ARCHS="90" -DBASELINE=OFF -DIDEAL_KERNEL=OFF -DOUT_32B=OFF && make -j 16
